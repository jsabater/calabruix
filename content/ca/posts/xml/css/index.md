...
Anem a aplicar un full d'estils CSS a {{< icon "download" >}} [l'exemple de l'institut](/downloads/xml/css/institut.xml) que hem usat en aquesta sèrie. El document XML quedaria segons segueix:
...
Acompanyariem el document anterior amb el {{< icon "download" >}} [corresponent full d'estils CSS](/downloads/xml/css/institut.css):
