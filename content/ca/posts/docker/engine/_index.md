...
Cada tema combina explicacions teòriques amb exemples pràctics i exercicis per consolidar els coneixements, establint la base necessària per a les sèries posteriors sobre Docker Compose i Docker Swarm.
