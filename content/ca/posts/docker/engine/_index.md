...
3. [Gestió de contenidors]({{<relref "/posts/docker/engine/" >}}): Execució, inspecció, logs, interacció i còpia de fitxers
4. [Volums i persistència]({{<relref "/posts/docker/engine/" >}}): Tipus de muntatge, gestió de volums, bind mounts
5. [Dockerfiles i construcció d'imatges]({{<relref "/posts/docker/engine/" >}}): Instruccions, `.dockerignore`, capes, cache i multi-stage builds
6. [Xarxes Docker]({{<relref "/posts/docker/engine/" >}}): Tipus de xarxes, resolució DNS, comunicació entre contenidors
